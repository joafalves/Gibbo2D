...
namespace Xceed.Wpf.Toolkit.PropertyGrid.Editors
{
    public abstract class TypeEditor<T> : ITypeEditor where T : FrameworkElement, new()
    {
        ...
        protected virtual IValueConverter CreateValueConverter(Type type = null)
        {
            if (type == typeof(Microsoft.Xna.Framework.Color))
            {
                return new XNAColorConverter();
            }
        ...
        protected virtual void ResolveValueBinding(PropertyItem propertyItem)
        {
            ...
            _binding.Converter = CreateValueConverter(propertyItem.PropertyType);
